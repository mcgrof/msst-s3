#!/usr/bin/env python3
"""
Test 1137: Concurrent uploads 4

Tests 4 concurrent multipart uploads
"""
...
def test_1137(s3_client, config):
    """Concurrent uploads 4"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-1137')
        ...
        if error_code in ['NotImplemented', 'InvalidRequest']:
            print(f"Test 1137 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 1137: {error_code}")
            raise

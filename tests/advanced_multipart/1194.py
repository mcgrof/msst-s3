#!/usr/bin/env python3
"""
Test 1194: Multipart metadata 1194
...
def test_1194(s3_client, config):
    """Multipart metadata 1194"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-1194')
        ...
        if error_code in ['NotImplemented', 'InvalidRequest']:
            print(f"Test 1194 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 1194: {error_code}")
            raise

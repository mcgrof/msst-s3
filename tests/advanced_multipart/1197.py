#!/usr/bin/env python3
"""
Test 1197: Multipart metadata 1197
...
def test_1197(s3_client, config):
    """Multipart metadata 1197"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-1197')
        ...
        if error_code in ['NotImplemented', 'InvalidRequest']:
            print(f"Test 1197 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 1197: {error_code}")
            raise

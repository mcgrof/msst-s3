#!/usr/bin/env python3
"""
Test 1195: Multipart metadata 1195
...
def test_1195(s3_client, config):
    """Multipart metadata 1195"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-1195')
        ...
        if error_code in ['NotImplemented', 'InvalidRequest']:
            print(f"Test 1195 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 1195: {error_code}")
            raise

#!/usr/bin/env python3
"""
Test 1180: Part replacement 1180
...
def test_1180(s3_client, config):
    """Part replacement 1180"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-1180')
        ...
        if error_code in ['NotImplemented', 'InvalidRequest']:
            print(f"Test 1180 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 1180: {error_code}")
            raise

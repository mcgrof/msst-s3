#!/usr/bin/env python3
"""
Test 1182: Multipart metadata 1182
...
def test_1182(s3_client, config):
    """Multipart metadata 1182"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-1182')
        ...
        if error_code in ['NotImplemented', 'InvalidRequest']:
            print(f"Test 1182 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 1182: {error_code}")
            raise

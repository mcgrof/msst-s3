#!/usr/bin/env python3
"""
Test 1187: Multipart metadata 1187
...
def test_1187(s3_client, config):
    """Multipart metadata 1187"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-1187')
        ...
        if error_code in ['NotImplemented', 'InvalidRequest']:
            print(f"Test 1187 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 1187: {error_code}")
            raise

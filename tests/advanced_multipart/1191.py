#!/usr/bin/env python3
"""
Test 1191: Multipart metadata 1191
...
def test_1191(s3_client, config):
    """Multipart metadata 1191"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-1191')
        ...
        if error_code in ['NotImplemented', 'InvalidRequest']:
            print(f"Test 1191 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 1191: {error_code}")
            raise

#!/usr/bin/env python3
"""
Test 1192: Multipart metadata 1192
...
def test_1192(s3_client, config):
    """Multipart metadata 1192"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-1192')
        ...
        if error_code in ['NotImplemented', 'InvalidRequest']:
            print(f"Test 1192 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 1192: {error_code}")
            raise

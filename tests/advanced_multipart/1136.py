#!/usr/bin/env python3
"""
Test 1136: Concurrent uploads 3
...
def test_1136(s3_client, config):
    """Concurrent uploads 3"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-1136')
        ...
        if error_code in ['NotImplemented', 'InvalidRequest']:
            print(f"Test 1136 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 1136: {error_code}")
            raise

#!/usr/bin/env python3
"""
Test 1193: Multipart metadata 1193
...
def test_1193(s3_client, config):
    """Multipart metadata 1193"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-1193')
        ...
        if error_code in ['NotImplemented', 'InvalidRequest']:
            print(f"Test 1193 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 1193: {error_code}")
            raise

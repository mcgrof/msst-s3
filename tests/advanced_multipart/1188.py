#!/usr/bin/env python3
"""
Test 1188: Multipart metadata 1188
...
def test_1188(s3_client, config):
    """Multipart metadata 1188"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-1188')
        ...
        if error_code in ['NotImplemented', 'InvalidRequest']:
            print(f"Test 1188 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 1188: {error_code}")
            raise

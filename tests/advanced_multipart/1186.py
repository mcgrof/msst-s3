#!/usr/bin/env python3
"""
Test 1186: Multipart metadata 1186
...
def test_1186(s3_client, config):
    """Multipart metadata 1186"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-1186')
        ...
        if error_code in ['NotImplemented', 'InvalidRequest']:
            print(f"Test 1186 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 1186: {error_code}")
            raise

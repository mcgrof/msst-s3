#!/usr/bin/env python3
"""
Test 1183: Multipart metadata 1183
...
def test_1183(s3_client, config):
    """Multipart metadata 1183"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-1183')
        ...
        if error_code in ['NotImplemented', 'InvalidRequest']:
            print(f"Test 1183 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 1183: {error_code}")
            raise

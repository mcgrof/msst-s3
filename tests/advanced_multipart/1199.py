#!/usr/bin/env python3
"""
Test 1199: Multipart metadata 1199
...
def test_1199(s3_client, config):
    """Multipart metadata 1199"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-1199')
        ...
        if error_code in ['NotImplemented', 'InvalidRequest']:
            print(f"Test 1199 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 1199: {error_code}")
            raise

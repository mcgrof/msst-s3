#!/usr/bin/env python3
"""
Test 1198: Multipart metadata 1198
...
def test_1198(s3_client, config):
    """Multipart metadata 1198"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-1198')
        ...
        if error_code in ['NotImplemented', 'InvalidRequest']:
            print(f"Test 1198 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 1198: {error_code}")
            raise

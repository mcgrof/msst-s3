#!/usr/bin/env python3
"""
Test 1179: Part replacement 1179
...
def test_1179(s3_client, config):
    """Part replacement 1179"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-1179')
        ...
        if error_code in ['NotImplemented', 'InvalidRequest']:
            print(f"Test 1179 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 1179: {error_code}")
            raise

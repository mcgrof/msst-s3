#!/usr/bin/env python3
"""
Test 1185: Multipart metadata 1185
...
def test_1185(s3_client, config):
    """Multipart metadata 1185"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-1185')
        ...
        if error_code in ['NotImplemented', 'InvalidRequest']:
            print(f"Test 1185 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 1185: {error_code}")
            raise

#!/usr/bin/env python3
"""
Test 1139: Concurrent uploads 6
...
def test_1139(s3_client, config):
    """Concurrent uploads 6"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-1139')
        ...
        if error_code in ['NotImplemented', 'InvalidRequest']:
            print(f"Test 1139 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 1139: {error_code}")
            raise

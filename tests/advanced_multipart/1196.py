#!/usr/bin/env python3
"""
Test 1196: Multipart metadata 1196
...
def test_1196(s3_client, config):
    """Multipart metadata 1196"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-1196')
        ...
        if error_code in ['NotImplemented', 'InvalidRequest']:
            print(f"Test 1196 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 1196: {error_code}")
            raise

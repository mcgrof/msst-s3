#!/usr/bin/env python3
"""
Test 1122: Concurrent uploads 4
...
def test_1122(s3_client, config):
    """Concurrent uploads 4"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-1122')
        ...
        if error_code in ['NotImplemented', 'InvalidRequest']:
            print(f"Test 1122 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 1122: {error_code}")
            raise

#!/usr/bin/env python3
"""
Test 1181: Multipart metadata 1181
...
def test_1181(s3_client, config):
    """Multipart metadata 1181"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-1181')
        ...
        if error_code in ['NotImplemented', 'InvalidRequest']:
            print(f"Test 1181 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 1181: {error_code}")
            raise

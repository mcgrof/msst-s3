#!/usr/bin/env python3
"""
Test 1164: Part replacement 1164
...
def test_1164(s3_client, config):
    """Part replacement 1164"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-1164')
        ...
        if error_code in ['NotImplemented', 'InvalidRequest']:
            print(f"Test 1164 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 1164: {error_code}")
            raise

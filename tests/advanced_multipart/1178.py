#!/usr/bin/env python3
"""
Test 1178: Part replacement 1178
...
def test_1178(s3_client, config):
    """Part replacement 1178"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-1178')
        ...
        if error_code in ['NotImplemented', 'InvalidRequest']:
            print(f"Test 1178 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 1178: {error_code}")
            raise

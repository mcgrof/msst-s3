#!/usr/bin/env python3
"""
Test 1184: Multipart metadata 1184
...
def test_1184(s3_client, config):
    """Multipart metadata 1184"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-1184')
        ...
        if error_code in ['NotImplemented', 'InvalidRequest']:
            print(f"Test 1184 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 1184: {error_code}")
            raise

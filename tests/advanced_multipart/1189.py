#!/usr/bin/env python3
"""
Test 1189: Multipart metadata 1189
...
def test_1189(s3_client, config):
    """Multipart metadata 1189"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-1189')
        ...
        if error_code in ['NotImplemented', 'InvalidRequest']:
            print(f"Test 1189 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 1189: {error_code}")
            raise

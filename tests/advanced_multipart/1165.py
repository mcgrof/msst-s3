#!/usr/bin/env python3
"""
Test 1165: Part replacement 1165
...
def test_1165(s3_client, config):
    """Part replacement 1165"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-1165')
        ...
        if error_code in ['NotImplemented', 'InvalidRequest']:
            print(f"Test 1165 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 1165: {error_code}")
            raise

#!/usr/bin/env python3
"""
Test 1172: Part replacement 1172
...
def test_1172(s3_client, config):
    """Part replacement 1172"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-1172')
        ...
        if error_code in ['NotImplemented', 'InvalidRequest']:
            print(f"Test 1172 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 1172: {error_code}")
            raise

#!/usr/bin/env python3
"""
Test 1161: Part replacement 1161
...
def test_1161(s3_client, config):
    """Part replacement 1161"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-1161')
        ...
        if error_code in ['NotImplemented', 'InvalidRequest']:
            print(f"Test 1161 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 1161: {error_code}")
            raise

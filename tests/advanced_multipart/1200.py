#!/usr/bin/env python3
"""
Test 1200: Multipart metadata 1200
...
def test_1200(s3_client, config):
    """Multipart metadata 1200"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-1200')
        ...
        if error_code in ['NotImplemented', 'InvalidRequest']:
            print(f"Test 1200 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 1200: {error_code}")
            raise

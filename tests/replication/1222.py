#!/usr/bin/env python3
"""
Test 1222: Replication delete_marker_replication
...
def test_1222(s3_client, config):
    """Replication delete_marker_replication"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-1222')
            ...
            if 'delete_marker_replication' == 'cross_region_replication':
                ...
                replication_config = {
                    ...
                    'Rules': [{
                        ...
                        'Status': 'Enabled',
                        'Destination': {
                            'Bucket': 'arn:aws:s3:::destination-bucket-1222'
                        }
                    }]
                }
                ...
                key = f'replicated-object-1222.txt'
        ...
        if error_code in ['NotImplemented', 'InvalidRequest']:
            print(f"Test 1222 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 1222: {error_code}")
            raise

#!/usr/bin/env python3
"""
Test 1291: Replication replication_time_control
...
def test_1291(s3_client, config):
    """Replication replication_time_control"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-1291')
            ...
            if 'replication_time_control' == 'cross_region_replication':
                ...
                replication_config = {
                    ...
                    'Rules': [{
                        ...
                        'Status': 'Enabled',
                        'Destination': {
                            'Bucket': 'arn:aws:s3:::destination-bucket-1291'
                        }
                    }]
                }
                ...
                key = f'replicated-object-1291.txt'
        ...
        if error_code in ['NotImplemented', 'InvalidRequest']:
            print(f"Test 1291 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 1291: {error_code}")
            raise

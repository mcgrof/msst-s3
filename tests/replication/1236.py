#!/usr/bin/env python3
"""
Test 1236: Replication replication_metrics
...
def test_1236(s3_client, config):
    """Replication replication_metrics"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-1236')
            ...
            if 'replication_metrics' == 'cross_region_replication':
                ...
                replication_config = {
                    ...
                    'Rules': [{
                        ...
                        'Status': 'Enabled',
                        'Destination': {
                            'Bucket': 'arn:aws:s3:::destination-bucket-1236'
                        }
                    }]
                }
                ...
                key = f'replicated-object-1236.txt'
        ...
        if error_code in ['NotImplemented', 'InvalidRequest']:
            print(f"Test 1236 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 1236: {error_code}")
            raise

#!/usr/bin/env python3
"""
Test 1220: Replication replication_metrics
...
def test_1220(s3_client, config):
    """Replication replication_metrics"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-1220')
            ...
            if 'replication_metrics' == 'cross_region_replication':
                ...
                replication_config = {
                    ...
                    'Rules': [{
                        ...
                        'Status': 'Enabled',
                        'Destination': {
                            'Bucket': 'arn:aws:s3:::destination-bucket-1220'
                        }
                    }]
                }
                ...
                key = f'replicated-object-1220.txt'
        ...
        if error_code in ['NotImplemented', 'InvalidRequest']:
            print(f"Test 1220 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 1220: {error_code}")
            raise

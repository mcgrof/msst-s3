#!/usr/bin/env python3
"""
Test 1208: Replication replication_filters
...
def test_1208(s3_client, config):
    """Replication replication_filters"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-1208')
            ...
            if 'replication_filters' == 'cross_region_replication':
                ...
                replication_config = {
                    ...
                    'Rules': [{
                        ...
                        'Status': 'Enabled',
                        'Destination': {
                            'Bucket': 'arn:aws:s3:::destination-bucket-1208'
                        }
                    }]
                }
                ...
                key = f'replicated-object-1208.txt'
        ...
        if error_code in ['NotImplemented', 'InvalidRequest']:
            print(f"Test 1208 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 1208: {error_code}")
            raise

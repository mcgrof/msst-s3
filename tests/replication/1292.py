#!/usr/bin/env python3
"""
Test 1292: Replication replication_metrics
...
def test_1292(s3_client, config):
    """Replication replication_metrics"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-1292')
            ...
            if 'replication_metrics' == 'cross_region_replication':
                ...
                replication_config = {
                    ...
                    'Rules': [{
                        ...
                        'Status': 'Enabled',
                        'Destination': {
                            'Bucket': 'arn:aws:s3:::destination-bucket-1292'
                        }
                    }]
                }
                ...
                key = f'replicated-object-1292.txt'
        ...
        if error_code in ['NotImplemented', 'InvalidRequest']:
            print(f"Test 1292 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 1292: {error_code}")
            raise

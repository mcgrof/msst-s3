#!/usr/bin/env python3
"""
Test 1203: Replication replication_time_control
...
def test_1203(s3_client, config):
    """Replication replication_time_control"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-1203')
            ...
            if 'replication_time_control' == 'cross_region_replication':
                ...
                replication_config = {
                    ...
                    'Rules': [{
                        ...
                        'Status': 'Enabled',
                        'Destination': {
                            'Bucket': 'arn:aws:s3:::destination-bucket-1203'
                        }
                    }]
                }
                ...
                key = f'replicated-object-1203.txt'
        ...
        if error_code in ['NotImplemented', 'InvalidRequest']:
            print(f"Test 1203 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 1203: {error_code}")
            raise

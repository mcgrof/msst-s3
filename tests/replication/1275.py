#!/usr/bin/env python3
"""
Test 1275: Replication replication_time_control
...
def test_1275(s3_client, config):
    """Replication replication_time_control"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-1275')
            ...
            if 'replication_time_control' == 'cross_region_replication':
                ...
                replication_config = {
                    ...
                    'Rules': [{
                        ...
                        'Status': 'Enabled',
                        'Destination': {
                            'Bucket': 'arn:aws:s3:::destination-bucket-1275'
                        }
                    }]
                }
                ...
                key = f'replicated-object-1275.txt'
        ...
        if error_code in ['NotImplemented', 'InvalidRequest']:
            print(f"Test 1275 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 1275: {error_code}")
            raise

#!/usr/bin/env python3
"""
Test 1268: Replication replication_metrics
...
def test_1268(s3_client, config):
    """Replication replication_metrics"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-1268')
            ...
            if 'replication_metrics' == 'cross_region_replication':
                ...
                replication_config = {
                    ...
                    'Rules': [{
                        ...
                        'Status': 'Enabled',
                        'Destination': {
                            'Bucket': 'arn:aws:s3:::destination-bucket-1268'
                        }
                    }]
                }
                ...
                key = f'replicated-object-1268.txt'
        ...
        if error_code in ['NotImplemented', 'InvalidRequest']:
            print(f"Test 1268 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 1268: {error_code}")
            raise

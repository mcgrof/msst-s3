#!/usr/bin/env python3
"""
Test 1225: Replication cross_region_replication
...
def test_1225(s3_client, config):
    """Replication cross_region_replication"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-1225')
            ...
            if 'cross_region_replication' == 'cross_region_replication':
                ...
                replication_config = {
                    ...
                    'Rules': [{
                        ...
                        'Status': 'Enabled',
                        'Destination': {
                            'Bucket': 'arn:aws:s3:::destination-bucket-1225'
                        }
                    }]
                }
                ...
                key = f'replicated-object-1225.txt'
        ...
        if error_code in ['NotImplemented', 'InvalidRequest']:
            print(f"Test 1225 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 1225: {error_code}")
            raise

#!/usr/bin/env python3
"""
Test 1260: Replication replication_metrics
...
def test_1260(s3_client, config):
    """Replication replication_metrics"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-1260')
            ...
            if 'replication_metrics' == 'cross_region_replication':
                ...
                replication_config = {
                    ...
                    'Rules': [{
                        ...
                        'Status': 'Enabled',
                        'Destination': {
                            'Bucket': 'arn:aws:s3:::destination-bucket-1260'
                        }
                    }]
                }
                ...
                key = f'replicated-object-1260.txt'
        ...
        if error_code in ['NotImplemented', 'InvalidRequest']:
            print(f"Test 1260 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 1260: {error_code}")
            raise

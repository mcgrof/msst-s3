#!/usr/bin/env python3
"""
Test 1265: Replication cross_region_replication
...
def test_1265(s3_client, config):
    """Replication cross_region_replication"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-1265')
            ...
            if 'cross_region_replication' == 'cross_region_replication':
                ...
                replication_config = {
                    ...
                    'Rules': [{
                        ...
                        'Status': 'Enabled',
                        'Destination': {
                            'Bucket': 'arn:aws:s3:::destination-bucket-1265'
                        }
                    }]
                }
                ...
                key = f'replicated-object-1265.txt'
        ...
        if error_code in ['NotImplemented', 'InvalidRequest']:
            print(f"Test 1265 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 1265: {error_code}")
            raise

#!/usr/bin/env python3
"""
Test 1288: Replication replication_filters
...
def test_1288(s3_client, config):
    """Replication replication_filters"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-1288')
            ...
            if 'replication_filters' == 'cross_region_replication':
                ...
                replication_config = {
                    ...
                    'Rules': [{
                        ...
                        'Status': 'Enabled',
                        'Destination': {
                            'Bucket': 'arn:aws:s3:::destination-bucket-1288'
                        }
                    }]
                }
                ...
                key = f'replicated-object-1288.txt'
        ...
        if error_code in ['NotImplemented', 'InvalidRequest']:
            print(f"Test 1288 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 1288: {error_code}")
            raise

#!/usr/bin/env python3
"""
Test 2772: K8s orchestration 2772
...
def test_2772(s3_client, config):
    """K8s orchestration 2772"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-2772')
        ...
        print(f"Container orchestration test 2772: ✓")
        ...
        if error_code in ['NotImplemented', 'InvalidRequest', 'UnsupportedOperation']:
            print(f"Test 2772 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 2772: {error_code}")
            raise

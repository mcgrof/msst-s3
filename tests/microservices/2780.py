#!/usr/bin/env python3
"""
Test 2780: K8s orchestration 2780
...
def test_2780(s3_client, config):
    """K8s orchestration 2780"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-2780')
        ...
        print(f"Container orchestration test 2780: ✓")
        ...
        if error_code in ['NotImplemented', 'InvalidRequest', 'UnsupportedOperation']:
            print(f"Test 2780 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 2780: {error_code}")
            raise

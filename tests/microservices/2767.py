#!/usr/bin/env python3
"""
Test 2767: K8s orchestration 2767
...
def test_2767(s3_client, config):
    """K8s orchestration 2767"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-2767')
        ...
        print(f"Container orchestration test 2767: ✓")
        ...
        if error_code in ['NotImplemented', 'InvalidRequest', 'UnsupportedOperation']:
            print(f"Test 2767 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 2767: {error_code}")
            raise

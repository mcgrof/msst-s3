#!/usr/bin/env python3
"""
Test 2764: K8s orchestration 2764
...
def test_2764(s3_client, config):
    """K8s orchestration 2764"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-2764')
        ...
        print(f"Container orchestration test 2764: ✓")
        ...
        if error_code in ['NotImplemented', 'InvalidRequest', 'UnsupportedOperation']:
            print(f"Test 2764 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 2764: {error_code}")
            raise

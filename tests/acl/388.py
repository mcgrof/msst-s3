...
def test_388(s3_client, config):
    """ACL aws-exec-read"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-388')
        ...
        print(f"Error in test 388: {e.response['Error']['Code']}")
        raise

...
def test_367(s3_client, config):
    """ACL aws-exec-read"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-367')
        ...
        print(f"Error in test 367: {e.response['Error']['Code']}")
        raise

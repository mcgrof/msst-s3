...
def test_311(s3_client, config):
    """ACL aws-exec-read"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-311')
        ...
        print(f"Error in test 311: {e.response['Error']['Code']}")
        raise

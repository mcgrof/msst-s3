...
def test_346(s3_client, config):
    """ACL aws-exec-read"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-346')
        ...
        print(f"Error in test 346: {e.response['Error']['Code']}")
        raise

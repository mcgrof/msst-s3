#!/usr/bin/env python3
"""
Test 209: Versioning version_acl

Tests versioning scenario: version_acl
"""
...
def test_209(s3_client, config):
    """Versioning version_acl"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-209')
        s3_client.create_bucket(bucket_name)

        # Versioning scenario: version_acl
        # Enable versioning
        ...
        print(f"Error in test 209: {e.response['Error']['Code']}")
        raise

...
def test_2691(s3_client, config):
    ...
    try:
        ...
        print(f"Edge caching strategy test 2691: ✓")
        ...
        if error_code in ['NotImplemented', 'InvalidRequest', 'UnsupportedOperation']:
            print(f"Test 2691 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 2691: {error_code}")
            raise

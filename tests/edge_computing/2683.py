...
def test_2683(s3_client, config):
    ...
    try:
        ...
        print(f"Edge caching strategy test 2683: ✓")
        ...
        if error_code in ['NotImplemented', 'InvalidRequest', 'UnsupportedOperation']:
            print(f"Test 2683 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 2683: {error_code}")
            raise

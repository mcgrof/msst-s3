...
def test_2689(s3_client, config):
    ...
    try:
        ...
        print(f"Edge caching strategy test 2689: ✓")
        ...
        if error_code in ['NotImplemented', 'InvalidRequest', 'UnsupportedOperation']:
            print(f"Test 2689 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 2689: {error_code}")
            raise

...
def test_2695(s3_client, config):
    ...
    try:
        ...
        print(f"Edge caching strategy test 2695: ✓")
        ...
        if error_code in ['NotImplemented', 'InvalidRequest', 'UnsupportedOperation']:
            print(f"Test 2695 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 2695: {error_code}")
            raise

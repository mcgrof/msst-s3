...
def test_2696(s3_client, config):
    ...
    try:
        ...
        print(f"Edge caching strategy test 2696: ✓")
        ...
        if error_code in ['NotImplemented', 'InvalidRequest', 'UnsupportedOperation']:
            print(f"Test 2696 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 2696: {error_code}")
            raise

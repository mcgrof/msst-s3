...
def test_2690(s3_client, config):
    ...
    try:
        ...
        print(f"Edge caching strategy test 2690: ✓")
        ...
        if error_code in ['NotImplemented', 'InvalidRequest', 'UnsupportedOperation']:
            print(f"Test 2690 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 2690: {error_code}")
            raise

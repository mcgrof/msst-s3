...
def test_2694(s3_client, config):
    ...
    try:
        ...
        print(f"Edge caching strategy test 2694: ✓")
        ...
        if error_code in ['NotImplemented', 'InvalidRequest', 'UnsupportedOperation']:
            print(f"Test 2694 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 2694: {error_code}")
            raise

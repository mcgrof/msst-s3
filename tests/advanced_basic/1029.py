#!/usr/bin/env python3
"""
Test 1029: Storage class GLACIER_IR
...
def test_1029(s3_client, config):
    """Storage class GLACIER_IR"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-1029')
        ...
        if error_code in ['NotImplemented', 'InvalidRequest']:
            print(f"Test 1029 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 1029: {error_code}")
            raise

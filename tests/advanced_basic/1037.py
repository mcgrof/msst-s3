#!/usr/bin/env python3
"""
Test 1037: Storage class OUTPOSTS
...
def test_1037(s3_client, config):
    """Storage class OUTPOSTS"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-1037')
        ...
        if error_code in ['NotImplemented', 'InvalidRequest']:
            print(f"Test 1037 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 1037: {error_code}")
            raise

#!/usr/bin/env python3
"""
Test 186: Multipart resume

Tests multipart resume operation
"""
...
def test_186(s3_client, config):
    """Multipart resume"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-186')
        s3_client.create_bucket(bucket_name)

        # Multipart operation: resume
        ...
        print(f"Error in test 186: {e.response['Error']['Code']}")
        raise

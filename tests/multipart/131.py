#!/usr/bin/env python3
"""
Test 131: Part size 11MB

Tests multipart with 11MB parts
"""
...
def test_131(s3_client, config):
    """Part size 11MB"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-131')
        s3_client.create_bucket(bucket_name)

        # Multipart with 11MB parts
        key = 'multipart-11mb.bin'
        ...
        print(f"Error in test 131: {e.response['Error']['Code']}")
        raise

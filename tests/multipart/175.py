...
def test_175(s3_client, config):
    """Multipart copy_part"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-175')
        ...
        print(f"Error in test 175: {e.response['Error']['Code']}")
        raise

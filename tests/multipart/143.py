...
def test_143(s3_client, config):
    """Multipart copy_part"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-143')
        ...
        print(f"Error in test 143: {e.response['Error']['Code']}")
        raise

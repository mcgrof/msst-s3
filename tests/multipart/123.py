#!/usr/bin/env python3
"""
Test 123: Part size 3MB

Tests multipart with 3MB parts
"""
...
def test_123(s3_client, config):
    """Part size 3MB"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-123')
        s3_client.create_bucket(bucket_name)

        # Multipart with 3MB parts
        key = 'multipart-3mb.bin'
        ...
        print(f"Error in test 123: {e.response['Error']['Code']}")
        raise

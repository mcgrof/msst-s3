#!/usr/bin/env python3
"""
Test 104: Multipart 2 parts

Tests multipart upload with 2 parts
"""
...
def test_104(s3_client, config):
    """Multipart 2 parts"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-104')
        s3_client.create_bucket(bucket_name)

        # Multipart upload with 2 parts
        ...
        print(f"Error in test 104: {e.response['Error']['Code']}")
        raise

...
def test_142(s3_client, config):
    """Multipart list_parts"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-142')
        ...
        print(f"Error in test 142: {e.response['Error']['Code']}")
        raise

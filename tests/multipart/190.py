...
def test_190(s3_client, config):
    """Multipart list_parts"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-190')
        ...
        print(f"Error in test 190: {e.response['Error']['Code']}")
        raise

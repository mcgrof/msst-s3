...
def test_199(s3_client, config):
    """Multipart copy_part"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-199')
        ...
        print(f"Error in test 199: {e.response['Error']['Code']}")
        raise

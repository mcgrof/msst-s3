#!/usr/bin/env python3
"""
Test 127: Part size 7MB

Tests multipart with 7MB parts
"""
...
def test_127(s3_client, config):
    """Part size 7MB"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-127')
        s3_client.create_bucket(bucket_name)

        # Multipart with 7MB parts
        key = 'multipart-7mb.bin'
        ...
        print(f"Error in test 127: {e.response['Error']['Code']}")
        raise

...
def test_194(s3_client, config):
    """Multipart resume"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-194')
        ...
        print(f"Error in test 194: {e.response['Error']['Code']}")
        raise

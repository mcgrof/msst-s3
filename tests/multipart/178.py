...
def test_178(s3_client, config):
    """Multipart resume"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-178')
        ...
        print(f"Error in test 178: {e.response['Error']['Code']}")
        raise

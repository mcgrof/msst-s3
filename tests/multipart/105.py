#!/usr/bin/env python3
"""
Test 105: Multipart 3 parts

Tests multipart upload with 3 parts
"""
...
def test_105(s3_client, config):
    """Multipart 3 parts"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-105')
        s3_client.create_bucket(bucket_name)

        # Multipart upload with 3 parts
        ...
        print(f"Error in test 105: {e.response['Error']['Code']}")
        raise

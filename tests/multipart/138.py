#!/usr/bin/env python3
"""
Test 138: Part size 18MB

Tests multipart with 18MB parts
"""
...
def test_138(s3_client, config):
    """Part size 18MB"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-138')
        s3_client.create_bucket(bucket_name)

        # Multipart with 18MB parts
        key = 'multipart-18mb.bin'
        ...
        print(f"Error in test 138: {e.response['Error']['Code']}")
        raise

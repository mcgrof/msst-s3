...
def test_154(s3_client, config):
    """Multipart resume"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-154')
        ...
        print(f"Error in test 154: {e.response['Error']['Code']}")
        raise

...
def test_170(s3_client, config):
    """Multipart resume"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-170')
        ...
        print(f"Error in test 170: {e.response['Error']['Code']}")
        raise

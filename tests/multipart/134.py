#!/usr/bin/env python3
"""
Test 134: Part size 14MB

Tests multipart with 14MB parts
"""
...
def test_134(s3_client, config):
    """Part size 14MB"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-134')
        s3_client.create_bucket(bucket_name)

        # Multipart with 14MB parts
        key = 'multipart-14mb.bin'
        ...
        print(f"Error in test 134: {e.response['Error']['Code']}")
        raise

#!/usr/bin/env python3
"""
Test 182: Multipart list_parts

Tests multipart list_parts operation
"""
...
def test_182(s3_client, config):
    """Multipart list_parts"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-182')
        s3_client.create_bucket(bucket_name)

        # Multipart operation: list_parts
        key = 'multipart-list_parts.bin'
        ...
        print(f"Error in test 182: {e.response['Error']['Code']}")
        raise

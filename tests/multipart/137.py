#!/usr/bin/env python3
"""
Test 137: Part size 17MB

Tests multipart with 17MB parts
"""
...
def test_137(s3_client, config):
    """Part size 17MB"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-137')
        s3_client.create_bucket(bucket_name)

        # Multipart with 17MB parts
        key = 'multipart-17mb.bin'
        ...
        print(f"Error in test 137: {e.response['Error']['Code']}")
        raise

...
def test_198(s3_client, config):
    """Multipart list_parts"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-198')
        ...
        print(f"Error in test 198: {e.response['Error']['Code']}")
        raise

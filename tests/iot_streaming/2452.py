...
def test_2452(s3_client, config):
    """RT analytics 2452"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-2452')
        ...
        print(f"Real-time analytics test 2452: ✓")
        ...
        if error_code in ['NotImplemented', 'InvalidRequest', 'UnsupportedOperation']:
            print(f"Test 2452 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 2452: {error_code}")
            raise

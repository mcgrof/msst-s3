...
def test_2451(s3_client, config):
    """RT analytics 2451"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-2451')
        ...
        print(f"Real-time analytics test 2451: ✓")
        ...
        if error_code in ['NotImplemented', 'InvalidRequest', 'UnsupportedOperation']:
            print(f"Test 2451 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 2451: {error_code}")
            raise

...
def test_2457(s3_client, config):
    """RT analytics 2457"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-2457')
        ...
        print(f"Real-time analytics test 2457: ✓")
        ...
        if error_code in ['NotImplemented', 'InvalidRequest', 'UnsupportedOperation']:
            print(f"Test 2457 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 2457: {error_code}")
            raise

...
def test_019(s3_client, config):
    ...
    try:
        # Create test buckets
        bucket_name = fixture.generate_bucket_name('test-019')
        bucket_name_2 = fixture.generate_bucket_name('test-019-dest')

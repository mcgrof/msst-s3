...
def test_30(s3_client, config):
    ...
    try:
        # Create buckets
        source_bucket = fixture.generate_bucket_name('test-30')
        log_bucket = fixture.generate_bucket_name('test-30-logs')

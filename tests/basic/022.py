...
def test_022(s3_client, config):
    ...
    try:
        # Create test buckets
        bucket_name = fixture.generate_bucket_name('test-022')
        destination_bucket = fixture.generate_bucket_name('test-022-inventory')

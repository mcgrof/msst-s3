#!/usr/bin/env python3
"""
Test 29: Analytics configuration
...
def test_29(s3_client, config):
    ...
    try:
        # Create test buckets
        bucket_name = fixture.generate_bucket_name('test-29')
        destination_bucket = fixture.generate_bucket_name('test-29-analytics')

#!/usr/bin/env python3
"""
Test 2229: Data partitioning 2229
...
def test_2229(s3_client, config):
    """Data partitioning 2229"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-2229')
        ...
        partition_key = f'data-lake/events/year={year}/month={month:02d}/day={day:02d}/hour={hour:02d}/data-2229.json'

        event_data = {
            'event_id': f'EVT000000002229',
        ...
        print(f"Data partitioning test 2229: ✓")
        ...
        if error_code in ['NotImplemented', 'InvalidRequest', 'UnsupportedOperation']:
            print(f"Test 2229 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 2229: {error_code}")
            raise

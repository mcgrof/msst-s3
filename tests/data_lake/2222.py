#!/usr/bin/env python3
"""
Test 2222: Data partitioning 2222
...
def test_2222(s3_client, config):
    """Data partitioning 2222"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-2222')
        ...
        partition_key = f'data-lake/events/year={year}/month={month:02d}/day={day:02d}/hour={hour:02d}/data-2222.json'

        event_data = {
            'event_id': f'EVT000000002222',
        ...
        print(f"Data partitioning test 2222: ✓")
        ...
        if error_code in ['NotImplemented', 'InvalidRequest', 'UnsupportedOperation']:
            print(f"Test 2222 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 2222: {error_code}")
            raise

#!/usr/bin/env python3
"""
Test 2239: Data partitioning 2239
...
def test_2239(s3_client, config):
    """Data partitioning 2239"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-2239')
        ...
        partition_key = f'data-lake/events/year={year}/month={month:02d}/day={day:02d}/hour={hour:02d}/data-2239.json'

        event_data = {
            'event_id': f'EVT000000002239',
        ...
        print(f"Data partitioning test 2239: ✓")
        ...
        if error_code in ['NotImplemented', 'InvalidRequest', 'UnsupportedOperation']:
            print(f"Test 2239 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 2239: {error_code}")
            raise

#!/usr/bin/env python3
"""
Test 2223: Data partitioning 2223
...
def test_2223(s3_client, config):
    """Data partitioning 2223"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-2223')
        ...
        partition_key = f'data-lake/events/year={year}/month={month:02d}/day={day:02d}/hour={hour:02d}/data-2223.json'

        event_data = {
            'event_id': f'EVT000000002223',
        ...
        print(f"Data partitioning test 2223: ✓")
        ...
        if error_code in ['NotImplemented', 'InvalidRequest', 'UnsupportedOperation']:
            print(f"Test 2223 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 2223: {error_code}")
            raise

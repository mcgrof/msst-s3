#!/usr/bin/env python3
"""
Test 2236: Data partitioning 2236
...
def test_2236(s3_client, config):
    """Data partitioning 2236"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-2236')
        ...
        partition_key = f'data-lake/events/year={year}/month={month:02d}/day={day:02d}/hour={hour:02d}/data-2236.json'

        event_data = {
            'event_id': f'EVT000000002236',
        ...
        print(f"Data partitioning test 2236: ✓")
        ...
        if error_code in ['NotImplemented', 'InvalidRequest', 'UnsupportedOperation']:
            print(f"Test 2236 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 2236: {error_code}")
            raise

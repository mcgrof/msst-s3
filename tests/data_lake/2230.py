#!/usr/bin/env python3
"""
Test 2230: Data partitioning 2230
...
def test_2230(s3_client, config):
    """Data partitioning 2230"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-2230')
        ...
        partition_key = f'data-lake/events/year={year}/month={month:02d}/day={day:02d}/hour={hour:02d}/data-2230.json'

        event_data = {
            'event_id': f'EVT000000002230',
        ...
        print(f"Data partitioning test 2230: ✓")
        ...
        if error_code in ['NotImplemented', 'InvalidRequest', 'UnsupportedOperation']:
            print(f"Test 2230 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 2230: {error_code}")
            raise

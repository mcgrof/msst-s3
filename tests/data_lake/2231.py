#!/usr/bin/env python3
"""
Test 2231: Data partitioning 2231
...
def test_2231(s3_client, config):
    """Data partitioning 2231"""
    fixture = TestFixture(s3_client, config)
    bucket_name = None

    try:
        bucket_name = fixture.generate_bucket_name('test-2231')
        ...
        partition_key = f'data-lake/events/year={year}/month={month:02d}/day={day:02d}/hour={hour:02d}/data-2231.json'

        event_data = {
            'event_id': f'EVT000000002231',
        ...
        print(f"Data partitioning test 2231: ✓")
        ...
        if error_code in ['NotImplemented', 'InvalidRequest', 'UnsupportedOperation']:
            print(f"Test 2231 - Feature not supported: {error_code}")
        else:
            print(f"Error in test 2231: {error_code}")
            raise
